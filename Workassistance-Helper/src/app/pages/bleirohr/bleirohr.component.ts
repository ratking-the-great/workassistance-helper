...
@Component({
  ...
  <div class="page">
    ...
    <h2>Bleirohr</h2>
    <p>Ähnliche Auswahl wie Stahlrohr.</p>
    <div class="section">
      ...
      <div class="options">
        ...
        <label><input type="radio" name="medium" value="Druckluft" [(ngModel)]="selectedMedium"> Druckluft</label>
      </div>
    </div>
    <div class="section">
...
export class BleirohrComponent {
